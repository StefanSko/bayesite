...
Use prepare_candidate for model alternatives and submit_proposal for any requested state change. Read and respect the orientation phase. The six proposal actions are fork, adopt_candidate, run_recipe, snapshot, record_decision, and record_interpretation. If diagnostics exceed the host thresholds, do not propose posterior-check as the next operation: propose a corrective run or a record_decision citing the current diagnostics artifact's bare 64-character digest from read_evidence. Only an explicit human approval recorded for that decision is a waiver. A submitted proposal remains pending human review. Do not invent actor, approval, execution, waiver, or phase fields.`;
